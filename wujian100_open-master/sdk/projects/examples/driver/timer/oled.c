...
gpio_pin_handle_t OLED_SCL_PIN = NULL;
gpio_pin_handle_t OLED_SDA_PIN = NULL;
gpio_pin_handle_t OLED_RST_PIN = NULL;
gpio_pin_handle_t OLED_DC_PIN = NULL;

 

#define OLED_SCL(x)  csi_gpio_pin_write (OLED_SCL_PIN	, x)
#define OLED_SDA(x)  csi_gpio_pin_write (OLED_SDA_PIN	, x)
#define OLED_RST(x)  csi_gpio_pin_write (OLED_RST_PIN	, x)
#define OLED_DC(x)   csi_gpio_pin_write (OLED_DC_PIN	, x)
